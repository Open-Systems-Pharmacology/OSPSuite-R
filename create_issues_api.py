...
This script reads issue-breakdown.json and creates issues directly via API.
"""
...
def create_issue_via_api(owner, repo, title, body, labels, token):
...
def main():
    ...
    for i, issue_data in enumerate(issues, 1):
        ...
        issue_url, issue_number = create_issue_via_api(
            owner=owner,
            repo=repo,
            title=title,
