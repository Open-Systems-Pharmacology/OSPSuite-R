...
#' allowing for easy identification of discrepancies.
#'
...
#'   Options are `"x"` (default, predicted on x-axis, observed on y-axis) or
#'   `"y"` (predicted on y-axis, observed on x-axis).
