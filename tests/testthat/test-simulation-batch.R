...
# Remove the parameter that is NaN. This parameter was added to simulation for testing purposes
parameterPaths <- parameterPaths[parameterPaths != "A|Molecular weight"]
...
test_that("Returns variable parameters/molecules lists, or NULL when none are specified", {
