...
test_that("It can retrieve all parameters matching a given criteria with generic path entry", {
  parameters <- getParameters(c("Organism", "Muscle", "**", "Volume"), sim)
