...
download.file("https://nightly.link/Open-Systems-Pharmacology/PK-Sim/workflows/build-and-test/develop/PKSim%20R%20Dependencies.zip",
              destfile = "pk-sim-r-dependencies_artefact.zip")

unzip("pk-sim-r-dependencies_artefact.zip",
      setTimes = TRUE,
      overwrite = T)
