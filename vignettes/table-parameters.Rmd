...
Direct access to the value points is possible through the `TableFormula` of the table parameter. All x- or y-values stored in the table can be conviniently retrieved using the `lapply` method:
