...
`MoBiModule$removeBuildingBlock()` removes single-type building blocks
(Molecules, Reactions, Spatial Structure, Passive Transports, Observers,
Event Groups) from a module by their type name:

```{r removeSingleTypeBB, eval = FALSE}
