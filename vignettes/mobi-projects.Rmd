...
TBD: should this return only the names of the Individuals and Expression Profiles,
or the  full objects (of type `BuildingBlock`)?
...
Each simulation has a `SimulationConfiguration` object that contains the modules used in the simulation, Individual, Expression Profiles, selection of the Initial Conditions and Parameter Values building blocks, and selection of partitioning coefficients for the molecules in the simulation.
...
sim1 <- myProject$createSimulationConfiguration(modulesNames = c("Thyroid_QST",
                                          "Rat physiology",
                                          "Thyroid",
                                          "Pituitary",
                                          "Endogenous_TH",
...
newPaths <- extendInitialConditions(icBB,
                                    spatialStructureBB = thyroidModule$getBuildingBlocks(type = "Spacial Structure"),
...
# EXPECTED BEHAVIOR
proteinExpressionPaths <- c("Organism|Thyroid|Plasma|DIO1|Initial concentration",
...
setParameterValues(pvBuildingBlock = pvBB,
...
simulationConfigurationHuman <- createSimulationConfiguration(simulationName = "Thyroid_QST_human",
                                            modules = c(modules[["Thyroid_QST"]],
                                                        thyroidModule,
                                                        modules[["Pituitary"]],
