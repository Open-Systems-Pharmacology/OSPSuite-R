...
# expProfiles <- myProject$getExpressionProfiles()
...
-   `setInitialConditions()`: Allows adding new entries or changing the values of existing entries in the Initial Conditions BB.
...
-   `setParameterValues()`: Allows adding new entries or changing the values of existing entries in the PV BB.
