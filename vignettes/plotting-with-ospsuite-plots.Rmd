...
```{r timeprofile-legend-per-dataset, eval=FALSE}
# Show all individual dataset names (both observed and simulated)
plotTimeProfile(myDataCombined, showLegendPerDataset = "all")

# Show only observed dataset names (different shapes)
plotTimeProfile(myDataCombined, showLegendPerDataset = "observed")

# Show only simulated dataset names (different line types)
plotTimeProfile(myDataCombined, showLegendPerDataset = "simulated")

# No per-dataset differentiation (default)
plotTimeProfile(myDataCombined, showLegendPerDataset = "none")
```
...
# Manually specify aesthetics for simulated data
plotTimeProfile(
  myDataCombined,
  mapping = ggplot2::aes(linetype = name)
)

# Manually specify aesthetics for observed data
plotTimeProfile(
  myDataCombined,
  observedMapping = ggplot2::aes(shape = name)
)

# Different aesthetics for each data type
plotTimeProfile(
  myDataCombined,
  mapping = ggplot2::aes(linetype = name),
  observedMapping = ggplot2::aes(shape = name, fill = name)
)
```
