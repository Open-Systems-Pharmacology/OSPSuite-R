...
2. **Configure the watermark option** using `options(ospsuite.plots.watermarkEnabled = TRUE)` or `options(ospsuite.plots.watermarkEnabled = FALSE)` 
...
# Show individual observed dataset names (different shapes)
plotPredictedVsObserved(myDataCombined, showLegendPerDataset = "observed")

# Same as "observed" for these scatter plots
