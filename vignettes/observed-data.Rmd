...
A `DataSet` objects stores numerical data pairs - typically the time 
as x values and measurement as y values - and optionally the (statistical) error of 
the measurement. All values have a *dimension*  and a *unit* (see [Dimensions and Units](unit-conversion.html) 
