...
```
 ...
 `calculatePKAnalyses` returns an object of the class `SimulationPKAnalyses`, which allows to retrieve either a certain PK-parameter for an output path, or all calculated PK-parameters for an output path.
...
Population analysis calculated in R can be exported to a *.csv file and be loaded in PK-Sim, and vice versa.
