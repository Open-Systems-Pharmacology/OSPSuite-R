...
# define the list of parameter that will be varied in the run. 
# We will vary 2 parameters: Lipophilicity and Permeability 
...
# other one with 4. That means that 3 run slots will be allocated for simBatch1 and 
# 4 will be allocated for simBatch2. These slots will remain in memory until the 
# batch object is discarded
...
# on how to match parameter set to results.
...
# Once the simulation batches instances are not need anymore, they can be removed 
