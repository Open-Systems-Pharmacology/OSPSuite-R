...
If the value is not constant, it is described by one of the formula types:
  ...
  **Distributed**: The value of the parameter is given by a distribution. In the simulation, the behavior equals that of constant values.
...
#Get the parameter defined a state variable.
