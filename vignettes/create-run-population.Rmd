...
simulationResults <- runSimulations(simulation = sim, population = myPopulation)
...
populationResults <- runSimulations(simulation = sim, population = myPopulation, simulationRunOptions = simRunOptions)
