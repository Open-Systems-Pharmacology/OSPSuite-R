...
The most important classes are:
  ...
  : `PKParameterSensitivity`
    : The sensitivity (field `$value`) of a PK-Parameter (`$pkParameterName`) for the output `$outputPath` calculated for the variated parameter `$parameterPath`. See [Sensitivity analysis](sensitivity-analysis.html) for more information.
