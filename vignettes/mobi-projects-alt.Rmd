---
title: "Working with MoBi projects - alternative"
...
sim1 <- myProject$createSimulation(simulationName = "Thyroid_QST_rat", 
...
Finally, we can create a simulation from the modules and the individual we created:

```{r createSimulationFromModules}
simulationHuman <- createSimulationFromModules(simulationName = "Thyroid_QST_human",
...
# create simulations based on configurations from a project, e.g., by exchangin one of the modules, or modifying it
