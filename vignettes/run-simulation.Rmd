...
# Keep relative tolerance unchanged (or adjust if needed)
sim$solver$relTol <- sim$solver$relTol
...
* `useJacobian`: Whether to use the Jacobian matrix during calculations
