...
> Residuals are calculated as: Observed value / Simulated value. Values around 1.0 indicate good model fit, values > 1.0 indicate the model under-predicts, and values < 1.0 indicate the model over-predicts.
> 
> **Note:** Division by zero (when simulated value is 0) produces Inf. These points will be automatically excluded from the results, and a warning will be issued.
